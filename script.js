...
const phrases = [
  "Node.js and TypeScript REST APIs for financial workflows",
  "AWS Lambda, API Gateway, DynamoDB, SQS, and EventBridge",
  "schema-validated JSON/XML partner integrations",
  "AI-agent middleware with OpenAI APIs and AWS Bedrock",
  "p95 latency tuning, tracing, caching, and CI quality gates"
];
